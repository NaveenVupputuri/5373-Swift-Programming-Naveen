...
class ViewController: UIViewController , ColorTableViewControllerDelegate{
    ...
    @IBOutlet weak var hValue: UITextField!
    @IBOutlet weak var sValue: UITextField!
    @IBOutlet weak var lValue: UITextField!
    
    @IBOutlet weak var hhValue: UITextField!
    ...
    func ColorTableViewChooseColor(controller: ColorTableViewController, chosenColor color: String){
        ...
        let hh = Float(255*hsv.H)
        let ss = Float(255*hsv.S)
