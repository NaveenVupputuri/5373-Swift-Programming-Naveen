...
class ViewController: UIViewController {
    ...
    func matchColorLogic() -> Bool{
        ...
        var randColor = self.myColors.fetchRandomColor()
        var randColor1 = self.myColors.fetchRandomColor()
        var randColor2 = self.myColors.fetchRandomColor()
        
        lblChangeColor.backgroundColor = self.myColors.hexStringToUIColor(randColor.hexValue)
        ...
        if(buttonAnswer == 0){
            ...
            btnAnswer2OUTLET.setTitle(randColor1.colorName, forState: UIControlState.Normal)
            btnAnswer3OUTLET.setTitle(randColor2.colorName, forState: UIControlState.Normal)
            button1Correct = true;
            
        }
        
        if(buttonAnswer == 1){
            btnAnswer1OUTLET.setTitle(randColor1.colorName, forState: UIControlState.Normal)
